...
export const fallbackExperiences: Experience[] = [
  {
    ...
    tech_stack: ['Avalonia UI', '.NET 8', 'C#', 'SQLite', 'EF Core', 'MVVM'],
  ...
  },
  {
    ...
    tech_stack: ['Docker', 'Docker Compose', 'FastAPI', 'MongoDB'],
  ...
  },
  {
    ...
    tech_stack: ['Node.js', 'Express', 'Appwrite', 'OAuth'],
  ...
  {
    id: '4',
    title: 'UI/UX Improvements & Responsive Design',
    ...
    tech_stack: ['Tailwind CSS', 'Avalonia UI', 'Responsive Design', 'UI/UX'],
    start_date: '2024-01-01',
    end_date: null,
    current: true,
    order_index: 4,
  ...
  {
    id: '5',
    title: 'Backend Authentication & RBAC Implementation',
    organization: 'Personal Projects',
    description:
    ...
    tech_stack: ['C#', '.NET 8', 'RBAC', 'Authentication', 'EF Core'],
